...
const Footer = () => {
    return (
        <div className='h-auto p-4 w-screen bg-cyan-500 flex justify-center mt-4'>
            <div className='flex flex-col justify-center items-center '>
                ...
                <p className='text-white w-1/2 justify-center mt-2'>
                ...
                <p className='text-white m-2 justify-center items-center'>
                    &copy All Rights Reserve Suman
                </p>
            </div>
        </div>
    )
